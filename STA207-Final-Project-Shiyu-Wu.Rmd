...
Since the 2-tailed critical t-value for $\alpha=0.05$ with 339 observations is 1.967, and the t-statistics for the three class types are ${188.461,5.264,5.180}$, which are far larger than the critical value, the null hypothesis is rejected. Thus, the treatment effect between class types and median math grades exists. Additionally, since the 95% confidence interval of the small class, $[1.84\times 10^{-3},1.88\times 10^{-3}]$, is much larger than the other two, $[2.69\times 10^{-5},5.88\times 10^{-5}]$ and $[2.72\times 10^{-5},6.03\times 10^{-5}]$, there is strong evidence to suggest that the small class should consistently have the best median math scaled grade.
